...
<table>
  <tr>
    ...
    <td rowspan="5"><br><br><p align="center"><small>Hi there 👋🏼 I’m Duygu, an <code>efficiency-obsessed</code> ML Engineer and Logic Synthesiser. I design scalable pipelines and explainable AI systems that don’t just work, but make sense.</small></p><p align="center"><samp><sup>I believe the best systems are explainable (if you can’t explain it, you don’t understand it), systematic (architecture is chaos, thoughtfully organized), and beautiful (code is craft, and aesthetics matter).</sup></samp></p><br>

<div align="center">
  <img width="180" src="https://cdn.jsdelivr.net/gh/dduyg/LiminalLoop@shelf/06/bins-and-balls.gif">
